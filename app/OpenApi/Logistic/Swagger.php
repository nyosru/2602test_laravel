...
namespace App\OpenApi\Logistic;
...
#[OA\Info(
    version: '1.0.1',
    title: 'Logistic API',
    description: 'API для резервирования слотов и управления активными удержаниями'
)]
#[OA\Server(
    url: '/api/logistic',
...
class Swagger
{
    ...
    #[OA\Schema(
        ...
        properties: [
            ...
            new OA\Property(property: 'expires_at', type: 'string', format: 'date-time', example: '2026-03-30T18:00:00+00:00'),
        ]
    )]
